import { Repo, Repository, Sequence, SequenceOptions } from "../../src/index";
import { DummyAdapter } from "./DummyAdapter";
import { RamSequenceModel } from "../../src/ram/index";
import { InternalError, NotFoundError } from "@decaf-ts/db-decorators";

export class DummySequence extends Sequence {
  protected repo: Repo<RamSequenceModel>;

  constructor(options: SequenceOptions, adapter: DummyAdapter) {
    super(options);
